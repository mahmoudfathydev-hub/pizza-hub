...
const dictionaries = {
    ar: {
        home: () => import('@/src/dictionaries/home/ar.json').then((module) => module.default as HomeTranslations),
        about: () => import('@/src/dictionaries/about/ar.json').then((module) => module.default as AboutTranslations),
        cart: () => import('@/src/dictionaries/cart/ar.json').then((module) => module.default as CartTranslations),
        contact: () => import('@/src/dictionaries/contact/ar.json').then((module) => module.default as ContactTranslations),
    ...
    en: {
        ...
        about: () => import('@/src/dictionaries/about/en.json').then((module) => module.default as AboutTranslations),
        cart: () => import('@/src/dictionaries/cart/en.json').then((module) => module.default as CartTranslations),
        contact: () => import('@/src/dictionaries/contact/en.json').then((module) => module.default as ContactTranslations),
...
const getTrans = async <T extends PageType>(locale: Locale, page: T): Promise<any> => {
