    ...
    return (
        <section className="container mx-auto section-gap bg-neutral-50 rounded-[3rem] p-8 md:p-16">
            <div className="text-center mb-12" data-aos="fade-down">
                <MainHeading title={t.branches?.title || ''} subTitle={t.branches?.subtitle || ''} />
                ...
                {branches.map((branch, index) => (
                    ...
                    >
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <span className="text-xs font-bold bg-green-100 text-green-700 px-3 py-1 rounded-full">{t.branches?.open || ''}</span>
                        </div>
                        ...
                        <div className="flex justify-between items-center text-sm">
                            <span className="font-bold text-gray-400">{t.branches?.hours || ''}</span>
