...
export const updateProfile = async (
    ...
    const formDataObj = Object.fromEntries(formData.entries()) as Record<string, string | File>;
    // Remove isAdmin from the data before validation
    delete formDataObj.isAdmin;
    const result = updateProfileSchema(profileTranslations).safeParse(formDataObj);
