-- CreateEnum
CREATE TYPE "ProductSizes" AS ENUM ('SMALL', 'MEDIUM', 'LARGE', 'FAMILY');

-- CreateEnum
CREATE TYPE "ExtraIngredients" AS ENUM ('MOZZARELLA', 'CHEDDAR', 'BLUE_CHEESE', 'PARMESAN', 'PEPPERONI', 'BACON', 'CHICKEN', 'SAUSAGE', 'MUSHROOMS', 'OLIVES', 'BELL_PEPPERS', 'SPINACH', 'ONIONS', 'JALAPENOS', 'PINEAPPLE', 'TRUFFLE_OIL', 'GARLIC', 'CHEESE', 'TOMATO', 'PEPPER');
