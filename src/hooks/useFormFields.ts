...
interface Props extends IFormFieldsVariables {
  translations: Translations | ProfileTranslations | MenuItemsTranslations;
}
const useFormFields = ({ slug, translations }: Props) => {
  const loginFields = (): IFormField[] => [
    ...
    },
    {
      ...
      name: "password",
      placeholder: (translations as Translations).auth.login.password
        .placeholder,
      type: "password",
    },
  ];
  const signupFields = (): IFormField[] => [
    {
      ...
      name: "name",
      type: "text",
      placeholder: (translations as Translations).auth.register.name
        .placeholder,
      autoFocus: true,
    },
    {
      ...
      name: "email",
      type: "email",
      placeholder: (translations as Translations).auth.register.email
        .placeholder,
    },
    {
      ...
      name: "password",
      type: "password",
      placeholder: (translations as Translations).auth.register.password
        .placeholder,
    },
    {
      ...
      type: "password",
      placeholder: (translations as Translations).auth.register.confirmPassword
        .placeholder,
    },
  ];
  ...
  const profileFields = (): IFormField[] => [
    ...
    },
    {
      ...
      name: "streetAddress",
      type: "text",
      placeholder: (translations as ProfileTranslations).form.address
        .placeholder,
    },
    {
      ...
      name: "postalCode",
      type: "text",
      placeholder: (translations as ProfileTranslations).form.postalCode
        .placeholder,
    },
    {
    ...
    },
    {
      ...
      name: "country",
      type: "text",
      placeholder: (translations as ProfileTranslations).form.country
        .placeholder,
    },
  ];
  ...
  const addProductFields = (): IFormField[] => [
    {
      label: (translations as MenuItemsTranslations).form.name.label,
      name: "name",
      type: "text",
      placeholder: (translations as MenuItemsTranslations).form.name
        .placeholder,
      autoFocus: true,
    },
    {
      label: (translations as MenuItemsTranslations).form.description.label,
      name: "description",
      type: "text",
      placeholder: (translations as MenuItemsTranslations).form.description
        .placeholder,
    },
    {
      label: (translations as MenuItemsTranslations).form.basePrice.label,
      name: "basePrice",
      type: "text",
      placeholder: (translations as MenuItemsTranslations).form.basePrice
        .placeholder,
    },
  ];
